# HỆ THỐNG ZALO MINI APP QUẢN TRỊ HTX HƯNG YÊN & TRUY XUẤT NGUỒN GỐC
> **Thí điểm:** 03 Hợp tác xã tỉnh Hưng Yên (HTX An Ninh, HTX Đông Tảo, HTX Quyết Thắng)  
> **Tài liệu hướng dẫn chi tiết:** Xem file [HUONG_DAN_TRAI_NGHIEM_DEMO.md](file:///d:/Vinh/zaloapp/hungyenhtx/HUONG_DAN_TRAI_NGHIEM_DEMO.md)

## Khởi động nhanh bản Demo:
```bash
npm install
npm run start
